    ...
    function(t, e, n) {
      ...
      function p(t, e, n, r) {
        for (
          ...
          var l = c(a[s]);
          l.static || ((l = y(o, l, e, n, a)), o.push(l)),
            (i[t.indexOf(a[s])] = l),
            (l.moved = !1);
        }
        return i;
      ...
      function _(t, e, n) {
        return "horizontal" === e ? R(t) : O(t, n);
      }
      function O(t, e) {
        return [].concat(t).sort(function(t, n) {
          return t.y > n.y || (t.y === n.y && (e ? t.x < n.x : t.x > n.x))
            ? 1
            : t.y === n.y && t.x === n.x
            ? 0
            : -1;
    ...
    function(t, e, n) {
      ...
      var f = (function(t) {
        ...
        return (
          ...
          (e.prototype.onResizeStart = function(t, e, n, r, o, a) {
            var i = a.e,
              s = a.node,
              l = a.leftResize
                ? this.state.layout.reverse()
                : this.state.layout,
              c = (0, u.getLayoutItem)(l, t);
            c &&
              (this.setState({
                layout: l,
              ...
              this.props.onResizeStart(l, c, c, null, i, s));
          }),
          (e.prototype.onResize = function(t, e, n, o, a, i) {
            var s = i.e,
              l = i.node,
              c = i.leftResize,
              f = this.state,
              ...
              d = this.props,
              y = d.cols,
              g = d.preventCollision,
              m = (0, u.getLayoutItem)(p, t);
            if (m) {
              var v = void 0;
              if (g) {
                var b = (0, u.getAllCollisions)(
                  p,
                  r({}, m, { w: e, h: n })
                ).filter(function(t) {
                  return t.i !== m.i;
                ...
                if ((v = b.length > 0)) {
                  ...
                  b.forEach(function(t) {
                    t.x > m.x && (w = Math.min(w, t.x)),
                      t.y > m.y && (x = Math.min(x, t.y));
                  }),
                    Number.isFinite(w) && (m.w = w - m.x),
                    Number.isFinite(x) && (m.h = x - m.y);
                }
              }
              v || ((m.w = e), (m.h = n), (m.x = o));
              var S = { w: m.w, h: m.h, x: m.x, y: m.y, static: !0, i: t };
              this.props.onResize(p, h, m, S, s, l),
                this.setState({
                  layout: (0, u.compact)(p, this.compactType(), y, c),
                  activeDrag: S
                });
            }
          }),
          (e.prototype.onResizeStop = function(t, e, n, r, o, a) {
            var i = a.e,
              s = a.node,
              l = a.leftResize,
              c = this.state,
              ...
              p = c.oldResizeItem,
              h = this.props.cols,
              d = (0, u.getLayoutItem)(f, t);
            this.props.onResizeStop(f, p, d, null, i, s);
            var y = (0, u.compact)(f, this.compactType(), h, l),
              g = this.state.oldLayout;
            this.setState({
              activeDrag: null,
              layout: l ? f.reverse() : f,
              oldResizeItem: null,
              oldLayout: null
            }),
              this.onLayoutMaybeChanged(y, g);
          }),
...
*/
                ...
                oneOfType: function(t) {
                  ...
                  return c(function(e, n, r, o, a) {
                    for (var i = 0; i < t.length; i++) {
                      var s = t[i];
                      if (null == s(e, n, r, o, a, y)) return null;
                    }
                    return new u(
	...
	*/
        ...
        var E = (function() {
            ...
            if (t in e) return "";
            for (var n = 0; n < C.length; n++) if (k(t, C[n]) in e) return C[n];
            return "";
          })(),
          T = function(t, e) {
            if (!(t instanceof e))
          ...
          function r(t) {
            ...
            return (
              (e.onDragStart = function(t, n) {
                var r = e.props.onStart(t, nt(e, n));
                if (!1 === r) return !1;
              ...
              },
              {
                ...
                value: function() {
                  var t,
                    ...
                    l = {
                      x: Q(this) && s ? this.state.x : u.x,
                      y: Z(this) && s ? this.state.y : u.y
                    };
          ...
          (e.prototype.resizeHandler = function(t, e) {
            ...
            return function(r, o) {
              ...
              u && "w" === e[e.length - 1] && (i = -i),
                l && "n" === e[0] && (s = -s);
              var c = n.state.prevDelta;
              i = (i > 0 && c[0] < 0) || (i < 0 && c[0] > 0) ? 0 : i;
              var f = n.state.width + (u ? i : 0),
                p = n.state.height + (l ? s : 0),
                h = f !== n.state.width,
                d = p !== n.state.height;
              if ("onResize" !== t || h || d) {
                var y = n.runConstraints(f, p);
                (f = y[0]), (p = y[1]);
                var g = {};
                if ("onResizeStart" === t) g.resizing = !0;
                else if ("onResizeStop" === t)
                  (g.resizing = !1),
                    (g.slackW = g.slackH = 0),
                    (g.prevDelta = [0, 0]);
                else {
                  if (f === n.state.width && p === n.state.height) return;
                  (g.width = f), (g.height = p), (g.prevDelta = [i, s]);
                }
                var m = !1;
                e.includes("w") && (m = !0),
    ...
    function(t, e, n) {
      ...
      var p = (function(t) {
        ...
        return (
          ...
          (e.prototype.calcNewDimensions = function(t) {
            var e = t.height,
              n = t.width,
              r = this.props,
              o = r.margin,
              ...
              f = l;
            return {
              w: (l = Math.round((n + o[0]) / (c + o[0]))),
              h: Math.round((e + o[1]) / (a + o[1])),
              x: (s = this.state.leftResize ? s + (f - l) : s),
              y: u
            };
          }),
          ...
          (e.prototype.mixinResizable = function(t, e) {
            var n = this.props,
              ...
              c = n.maxH,
              f =
                (this.calcPosition(0, 0, r - a, 0).width,
                this.calcPosition(0, 0, i, u)),
              p = this.calcPosition(0, 0, l, c),
              h = [f.width, f.height],
              d = [p.width, Math.min(p.height, 1 / 0)];
            return o.default.createElement(
              s.Resizable,
              {
                width: e.width,
          ...
          (e.prototype.onResizeHandler = function(t) {
            ...
            return function(n, r) {
              ...
              if (s) {
                ...
                var w = !!i;
                e.setState({
                  resizing: "onResizeStop" === t ? null : a,
                  leftResize: w
                }),
                  s.call(e, c, g, m, v, b, {
                    e: n,
