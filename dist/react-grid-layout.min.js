        ...
        return (
          ...
          (e.prototype.onResize = function(t, e, n, o, a, i) {
            var s = i.e,
              ...
              h = this.props,
              d = h.cols,
              y = h.preventCollision,
              g = (0, u.getLayoutItem)(f, t);
            if (g) {
              var m = void 0;
              if (y) {
                var v = (0, u.getAllCollisions)(
                  f,
                  r({}, g, { w: e, h: n })
                ).filter(function(t) {
                  return t.i !== g.i;
                ...
                if ((m = v.length > 0)) {
                  ...
                  v.forEach(function(t) {
                    t.x > g.x && (b = Math.min(b, t.x)),
                      t.y > g.y && (w = Math.min(w, t.y));
                  }),
                    Number.isFinite(b) && (g.w = b - g.x),
                    Number.isFinite(w) && (g.h = w - g.y);
                }
              }
              m || ((g.w = e), (g.h = n), (g.x = o));
              var x = { w: g.w, h: g.h, x: g.x, y: g.y, static: !0, i: t };
              this.props.onResize(f, p, g, x, s, l),
                this.setState({
                  layout: (0, u.compact)(f, this.compactType(), d),
                  activeDrag: x
                });
            }
          }),
          (e.prototype.onResizeStop = function(t, e, n, r, o, a) {
            var i = a.e,
              ...
              f = l.oldResizeItem,
              p = this.props.cols,
              h = (0, u.getLayoutItem)(c, t);
            this.props.onResizeStop(c, f, h, null, i, s);
            var d = (0, u.compact)(c, this.compactType(), p),
            ...
            return function(r, o) {
              ...
              if ("onResize" !== t || p || h) {
                ...
                if ("onResizeStart" === t) y.resizing = !0;
                  ...
                  (y.width = c),
                    (y.height = f),
                    (i = Math.round((n.state.prevDelta[0] + i) / 2)),
                    (s = Math.round((n.state.prevDelta[1] + s) / 2)),
                    (y.prevDelta = [i, s]);
                }
                var g = !1;
                e.includes("w") && (g = !0),
            ...
            return function(n, r) {
              ...
              if (s) {
                ...
                (g = Math.min(g, l - v)),
                  ...
                  "onResizeStart" === t && i
                    ? e.setState({ leftResize: !0 })
                    : "onResizeStop" === t && e.setState({ leftResize: !1 }),
                  e.setState({ resizing: "onResizeStop" === t ? null : a }),
                  s.call(e, c, g, m, v, b, { e: n, node: o, size: a });
              }
            };
          }),
          (e.prototype.render = function() {
