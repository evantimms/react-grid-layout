...
var ResponsiveReactGridLayout = function (_React$Component) {
  ...
  ResponsiveReactGridLayout.prototype.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(prevProps) {
    // Allow parent to set width or breakpoint directly.
    if (prevProps.width != this.props.width || prevProps.breakpoint !== this.props.breakpoint || !(0, _lodash2.default)(prevProps.breakpoints, this.props.breakpoints) || !(0, _lodash2.default)(prevProps.cols, this.props.cols)) {
      ...
      var newLayout = (0, _responsiveUtils.findOrGenerateResponsiveLayout)(prevProps.layouts, prevProps.breakpoints, _breakpoint, _breakpoint, _cols, prevProps.compactType);
