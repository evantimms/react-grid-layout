...
var ReactGridLayout = function (_React$Component) {
  ...
  ReactGridLayout.prototype.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(prevProps) {
    var newLayoutBase = void 0;
    // Legacy support for compactType
    // Allow parent to set layout directly.
    if (!(0, _lodash2.default)(prevProps.layout, this.props.layout) || prevProps.compactType !== this.props.compactType) {
      newLayoutBase = prevProps.layout;
    } else if (!(0, _utils.childrenEqual)(this.props.children, prevProps.children)) {
    ...
    if (newLayoutBase) {
      var newLayout = (0, _utils.synchronizeLayoutWithChildren)(newLayoutBase, prevProps.children, prevProps.cols, this.compactType(prevProps));
  ...
  ReactGridLayout.prototype.onResizeStart = function onResizeStart(i, w, h, x, y, _ref4) {
    var e = _ref4.e,
        node = _ref4.node;
    var layout = this.state.layout;
  ...
  ReactGridLayout.prototype.onResize = function onResize(i, w, h, x, y, _ref5) {
    var e = _ref5.e,
        node = _ref5.node;
  ...
  ReactGridLayout.prototype.onResizeStop = function onResizeStop(i, w, h, x, y, _ref6) {
    var e = _ref6.e,
        node = _ref6.node;
